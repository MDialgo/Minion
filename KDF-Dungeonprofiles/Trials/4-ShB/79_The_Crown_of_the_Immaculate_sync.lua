local tbl = {
	...
	interacts = {
		[2] = {contentid = 2000139, priority = 1, req = {type = "noenemy"}, type = "Exit"},
	},
	...
	prioritytarget = {
		...
		[3] = {contentid = 8353, priority = 3, type = "Immaculate Spirit Lord" },
	},
	advancedavoid = {
		...
		[9] = {castingid = 16064, type = "custom", customdetails = "function", functionname = "customfunction",
			functioncode = [[
...
return tbl
--[[ --Old function
[9] = { castingid=16064, type="custom", customdetails = "libraryfunction", functioncode = "wxlj_follow()" }
function wxlj_follow()
	if KitanoiSettings.DFTimer == 0 then
		KitanoiSettings.DFTimer = Now()
	elseif TimeSince(KitanoiSettings.DFTimer) < 12000 then
