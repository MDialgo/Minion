...
--	mesh = "The Navel", --if uncommented it reloads to bigger platform
	...
	interacts = {
		...
		-- Tremor Earrings, Crag Heart, Gullfaxi Whistle, Nightmare Whistle & Faded Copy of Under the Weight
	},
	bossids = {
		1801, -- Titan -- Titan Card
	},
	enemytargetdistance = 50,
	prioritytarget = {
		[1] = {contentid = 1801, priority = 3, type = "Titan"},
	},
	avoidentity = {},
	advancedavoid = {
