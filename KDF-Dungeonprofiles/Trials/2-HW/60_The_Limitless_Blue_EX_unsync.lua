local tbl = {
	...
	interactdistance = 50,
	interacts = {
		[1] = {contentid = 471, priority = 1, type = "Loot"},
		-- Expanse Weapons, Expanse Baleen, White Lanner Whistle, Faded Copy of Limitless Blue & Faded Copy of Woe That Is Madness
	},
	bossids = {
