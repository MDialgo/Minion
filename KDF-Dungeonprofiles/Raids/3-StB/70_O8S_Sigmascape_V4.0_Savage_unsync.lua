local tbl = {
	name = "O8S Sigmascape V4.0 (Savage)",
	mesh = "Sigmascape V4.0",
	dutyid = 755, -- ID de la map
	level = 70,
	expansion = 4,
	creator = "Koyote#6642",
	notes = "",
	...
	interacts = {
		[1] = {contentid = 1009, priority = 1, type = "Loot 1"},
		[2] = {contentid = 1008, priority = 2, type = "Loot 2"},
		[3] = {contentid = 1024, priority = 3, type = "Loot 3"},
	},
