local tbl = {
	name = "[Sq] Brayflox's Longstop (Hard)",
	...
	limitbreak = {
		[1] = {contentid = 2549, percent = 95, level = 1, type = "squadron"},
		[2] = {contentid = 2547, percent = 95, level = 2, type = "squadron"},
		[3] = {contentid = 2547, percent = 95, level = 1, type = "squadron"},
	},
