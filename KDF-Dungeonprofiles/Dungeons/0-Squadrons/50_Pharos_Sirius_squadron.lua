local tbl = {
	...
	interacts = {
		...
		--[5] = {contentid = 233, priority = 5, type = "Loot 4"},
	...
	limitbreak = {
		[1] = {contentid = 2261, percent = 95, level = 1, type = "squadron"},
		[2] = {contentid = 2265, percent = 95, level = 2, type = "squadron"},
		[3] = {contentid = 2265, percent = 95, level = 1, type = "squadron"},
	},
