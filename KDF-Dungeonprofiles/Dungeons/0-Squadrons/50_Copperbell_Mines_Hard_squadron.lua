local tbl = {
	...
	excludeavoid = {},
	limitbreak = {
		[1] = {contentid = 2285, percent = 95, level = 1, type = "squadron"},
		[2] = {contentid = 2289, percent = 95, level = 2, type = "squadron"},
		[3] = {contentid = 2289, percent = 95, level = 1, type = "squadron"},
	},
