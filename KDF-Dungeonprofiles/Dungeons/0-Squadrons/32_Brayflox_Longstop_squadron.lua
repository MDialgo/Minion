local tbl = {
	...
	excludeavoid = {563},
	limitbreak = {
		[1] = {contentid = 1286, percent = 95, level = 1, type = "squadron"},
		[2] = {contentid = 1279, percent = 95, level = 2, type = "squadron"},
		[3] = {contentid = 1279, percent = 95, level = 1, type = "squadron"},
	},
}
