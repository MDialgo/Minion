local tbl = {
	...
	dontexcludeaoe = {1167},
	limitbreak = {
		[1] = {contentid = 1415, percent = 95, level = 1, type = "squadron"},
		[2] = {contentid = 1396, percent = 95, level = 2, type = "squadron"},
		[3] = {contentid = 1396, percent = 95, level = 1, type = "squadron"},
	},
