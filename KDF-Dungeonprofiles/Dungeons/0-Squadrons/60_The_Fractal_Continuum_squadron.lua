local tbl = {
	...
	excludeavoid = {},
	limitbreak = {
		[1] = {contentid = 3429, percent = 95, level = 1, type = "squadron"},
		[2] = {contentid = 3434, percent = 95, level = 2, type = "squadron"},
		[3] = {contentid = 3434, percent = 95, level = 1, type = "squadron"},
	},
